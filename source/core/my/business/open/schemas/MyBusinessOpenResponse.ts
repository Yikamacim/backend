...
export class MyBusinessOpenResponse implements IResponse {
  private constructor(
  ...
  public static fromEntity(entity: BusinessEntity): MyBusinessOpenResponse {
  ...
  public static fromEntities(entities: BusinessEntity[]): MyBusinessOpenResponse[] {
