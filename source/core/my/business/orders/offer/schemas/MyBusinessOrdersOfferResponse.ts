...
export class MyBusinessOrdersOfferResponse implements IResponse {
  private constructor(
  ...
  public static fromEntity(entity: OrderEntity): MyBusinessOrdersOfferResponse {
    return new MyBusinessOrdersOfferResponse(
  ...
  public static fromEntities(entities: OrderEntity[]): MyBusinessOrdersOfferResponse[] {
    return entities.map((entity) => MyBusinessOrdersOfferResponse.fromEntity(entity));
  }
}
