...
export class MyBusinessOrdersMessagesRequest implements IRequest {
  ...
  public static parse(req: ExpressRequest): ParserResponse<MyBusinessOrdersMessagesRequest | null> {
    ...
    if (!MyBusinessOrdersMessagesRequest.isBlueprint(protovalidData)) {
  ...
  private static isBlueprint(obj: unknown): obj is MyBusinessOrdersMessagesRequest {
    if (typeof obj !== "object" || obj === null) {
      return false;
    }
    const blueprint = obj as MyBusinessOrdersMessagesRequest;
