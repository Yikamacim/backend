...
export class MyBusinessOrdersResponse implements IResponse {
  private constructor(
  ...
  public static fromEntity(entity: OrderEntity): MyBusinessOrdersResponse {
    return new MyBusinessOrdersResponse(
  ...
  public static fromEntities(entities: OrderEntity[]): MyBusinessOrdersResponse[] {
    return entities.map((entity) => MyBusinessOrdersResponse.fromEntity(entity));
  }
}
