...
import { MyBusinessOrdersCancelProvider } from "./MyBusinessOrdersCancelProvider";
import type { MyBusinessOrdersCancelParams } from "./schemas/MyBusinessOrdersCancelParams";
import { MyBusinessOrdersCancelResponse } from "./schemas/MyBusinessOrdersCancelResponse";

export class MyBusinessOrdersCancelManager implements IManager {
  public constructor(private readonly provider = new MyBusinessOrdersCancelProvider()) {}

  public async putMyBusinessOrdersCancel(
    payload: TokenPayload,
    params: MyBusinessOrdersCancelParams,
  ): Promise<ManagerResponse<MyBusinessOrdersCancelResponse | null>> {
    ...
    return ResponseUtil.managerResponse(
      ...
      null,
      [],
      MyBusinessOrdersCancelResponse.fromEntity(entity),
    );
  }
}
