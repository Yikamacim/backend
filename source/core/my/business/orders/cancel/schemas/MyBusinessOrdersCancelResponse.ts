...
export class MyBusinessOrdersCancelResponse implements IResponse {
  private constructor(
  ...
  public static fromEntity(entity: OrderEntity): MyBusinessOrdersCancelResponse {
    return new MyBusinessOrdersCancelResponse(
  ...
  public static fromEntities(entities: OrderEntity[]): MyBusinessOrdersCancelResponse[] {
    return entities.map((entity) => MyBusinessOrdersCancelResponse.fromEntity(entity));
  }
}
