...
export class MyBusinessCloseResponse implements IResponse {
  private constructor(
  ...
  public static fromEntity(entity: BusinessEntity): MyBusinessCloseResponse {
    return new MyBusinessCloseResponse(
  ...
  public static fromEntities(entities: BusinessEntity[]): MyBusinessCloseResponse[] {
    return entities.map((entity) => MyBusinessCloseResponse.fromEntity(entity));
  }
}
