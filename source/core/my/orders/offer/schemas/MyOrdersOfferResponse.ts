...
export class MyOrdersOfferResponse implements IResponse {
  private constructor(
  ...
  public static fromEntity(entity: OrderEntity): MyOrdersOfferResponse {
    return new MyOrdersOfferResponse(
  ...
  public static fromEntities(entities: OrderEntity[]): MyOrdersOfferResponse[] {
    return entities.map((entity) => MyOrdersOfferResponse.fromEntity(entity));
  }
}
