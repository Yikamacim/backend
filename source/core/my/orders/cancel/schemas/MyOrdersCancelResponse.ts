...
export class MyOrdersCancelResponse implements IResponse {
  private constructor(
  ...
  public static fromEntity(entity: OrderEntity): MyOrdersCancelResponse {
    return new MyOrdersCancelResponse(
  ...
  public static fromEntities(entities: OrderEntity[]): MyOrdersCancelResponse[] {
    return entities.map((entity) => MyOrdersCancelResponse.fromEntity(entity));
  }
}
