...
export class MyOrdersResponse implements IResponse {
  private constructor(
  ...
  public static fromEntity(entity: OrderEntity): MyOrdersResponse {
  ...
  public static fromEntities(entities: OrderEntity[]): MyOrdersResponse[] {
    return entities.map((entity) => MyOrdersResponse.fromEntity(entity));
  }
}
