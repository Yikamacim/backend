...
import { CurtainMaterial } from "../../../../common/enums/CurtainMaterial";
  ...
  private static isBlueprint(obj: unknown): obj is MyCurtainsRequest {
    ...
    return (
      ...
      (blueprint.curtainType === null ||
        Object.values(CurtainType).includes(blueprint.curtainType)) &&
      (blueprint.curtainMaterial === null ||
        Object.values(CurtainMaterial).includes(blueprint.curtainMaterial))
    );
  }
}
