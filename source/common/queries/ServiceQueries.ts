export enum ServiceQueries {
  ...
  GET_SERVICE_$SVID = `SELECT * FROM "Service" WHERE "serviceId" = $1`,
  GET_SERVICE_$SVID_$ISDEL = `SELECT * FROM "Service" WHERE "serviceId" = $1 AND "isDeleted" = $2`,
  GET_SERVICE_$BSID_$SVID_$ISDEL = `SELECT * FROM "Service" WHERE "businessId" = $1 AND "serviceId" = $2 AND "isDeleted" = $3`,
