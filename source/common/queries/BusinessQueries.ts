export enum BusinessQueries {
  ...
  UPDATE_BUSINESS_RT_$ACID_$NAME_$ADID_$PHONE_$EMAIL_$DESC = `UPDATE "Business" SET "name" = $2, "addressId" = $3, "phone" = $4, "email" = $5, "description" = $6 WHERE "accountId" = $1 RETURNING *`,
